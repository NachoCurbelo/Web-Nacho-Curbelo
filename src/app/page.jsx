...
import logopedidosya from '@/images/logos/pedidosya.svg'
...
function Resume() {
  let resume = [
    {
      company: 'PedidosYa',
      title: 'Photography Editing Expert',
      logo: logopedidosya,
      start: '2018',
      end: {
        label: '2024',
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button href="https://drive.google.com/uc?export=download&id=11GCgEiNlxzltRQktlmFImjdKPCXblnGi" variant="secondary" className="group mt-6 w-full">
        Download CV
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I’m Ignacio, a freelance graphic, UX|UI designer and photographer based in Montevideo, Uruguay. 
          ...
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://www.linkedin.com/in/ignacio-curbelo-b73631150/"
